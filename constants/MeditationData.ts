// frontend/constants/MeditationData.ts
...
export const MEDITATION_DATA: MeditationType[] = [
  { id: 1, title: "Mountains", image: "trees.webp", audio: "trees.mp3" },
  { id: 2, title: "Rivers", image: "river.webp", audio: "river.mp3" },
  {
    id: 3,
    title: "Sunset",
  ...
  { id: 4, title: "Beaches", image: "beach.webp", audio: "beach.mp3" },
  {
    id: 5,
    title: "Starry Night",
...
// NOTE: MeditationData.ts lives at frontend/constants/
// audio files live at frontend/assets/audio/
// so the correct relative path is "../assets/audio/<file>"
